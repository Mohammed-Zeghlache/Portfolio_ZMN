...
// // import Denty from '../assets/images/Denty.png';
...
//                 <span key={i} className={`pf-tag ${tag.includes('ALGERIA') || tag.includes('BRAINERX') || tag.includes('HOGWARTS') || tag.includes('HACKATHON') || tag.includes('GRADUATION') || tag.includes('INTERACTIVE') || tag.includes('CLINIC') ? 'gold' : tag.includes('Gemini') || tag.includes('Three.js') || tag.includes('AI') || tag.includes('Hand') || tag.includes('JWT') || tag.includes('Prescription') ? 'blue' : 'pink'}`}>
//                   {tag}
//                 </span>
//               ))}
//             </div>
